...
if(isset($_GET['lang'])) {
  $lang = $_GET['lang'];
  $productText = '<p><span style="color: #ffffff; background-color: red;"> <i class="fa  fa-arrow-circle-down"></i> 新機能! <i class="fa  fa-arrow-circle-down"></i> </span>&nbsp;あなたのメッセージがオリジナル商品に！</p>';
}else{
...
<link rel="stylesheet" type="text/css" href="'.$contentUrl.'/src/css/owl.theme.css" />
  <link rel="stylesheet" type="text/css" href="'.$contentUrl.'/src/css/typograffit.css?123" />
  <!--  jQuery -->
  ...
  <!-- typograffit.js  -->
  <script src="'.$contentUrl.'/src/js/typograffit.js?123"> </script>
      ...
      <div id="typoText">
        ...
        <div id="emojiList">
        	<div id="emojiWrap">
		      <div class="item">
		      	<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'smile\'); return false;"><img class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/smile.png" alt="" /></a></li>
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'kissing\'); return false;"><img class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/kissing.png" alt="" /></a></li>
	      		</ul>
			  </div>
			  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'laughing\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/laughing.png" alt="" /></a></li>
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'sweat\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/sweat.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'scream\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/scream.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'sunglasses\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/sunglasses.png" alt="" /></a></li>
		      	</ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'wink\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/wink.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'angry\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/angry.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'sleeping\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/sleeping.png" alt=":smile:" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'sob\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/sob.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'heart\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/heart.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'kiss\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/kiss.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'star\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/star.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'poop\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/poop.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'dash\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/dash.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'notes\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/notes.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'eyes\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/eyes.png" alt=":smile:" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'skull\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/skull.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'musical_note\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/musical_note.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'zzz\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/zzz.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'sweat_drops\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/sweat_drops.png" alt=":smile:" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'thumbsup\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/thumbsup.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'thumbsdown\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/thumbsdown.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'hand\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/hand.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'v\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/v.png" alt=":smile:" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'pray\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/pray.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'clap\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/clap.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'metal\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/metal.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
	      	  <div class="item">
	      		<ul class="">
					<li class=""><a href="#" class="disable" onclick="insertEmoji(\'see_no_evil\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/see_no_evil.png" alt=":smile:" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'hear_no_evil\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/hear_no_evil.png" alt="" /></a></li>
	      	    </ul>
			  </div>
	      	  <div class="item">
		      	<ul class="">
	      			<li class=""><a href="#" class="disable" onclick="insertEmoji(\'speak_no_evil\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/speak_no_evil.png" alt="" /></a></li>
	      			<li class="lower"><a href="#" class="disable" onclick="insertEmoji(\'running\'); return false;"><img id="" class="lazyOwl" src="'.$contentUrl.'/src/images/emoji/running.png" alt="" /></a></li>
	      		</ul>
	      	  </div>
			</div>
        </div>
